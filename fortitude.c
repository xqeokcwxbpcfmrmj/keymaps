 ...
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  Alt |  GUI |Lower |Space |      |Space |Space |Raise |  RGUI|  ALT |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  KC_TAB,  KC_Q,    ALT_W,    CMD_E,    KC_R,    KC_T,                   KC_Y,    KC_U,    CMD_I,    ALT_O,    KC_P,    KC_BSLASH, \
  CTL_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, CTL_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, _______, _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_RSFT_ENT , \
                 KC_LALT, LCMD_RIGHT,   LOWER,  SPC_NUM, KC_SPC,  KC_SPC, SPC_NUM, RAISE,    RCMD_LEFT, RALT_DOWN\
),
...
[_COLEMAK] = LAYOUT( \
  ...
  KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,    KC_QUOT, \
 ...
 * |   `  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  | Del  |
 * |------+------+------+------+------+------|             |------+------+------+------+------+------|
 * | Tab  |  F1  |  F2  |  F3  |  F4  |  F5  |             |   F  |   G  |   C  |   R  |   L  | Bksp |
 * |------+------+------+------+------+------|             |------+------+------+------+------+------|
...
[_karjalasta] = LAYOUT( \
  ...
  KC_NO,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                   KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_BSPC, \
  KC_NO,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NO, \
  KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO,  , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DOT, KC_NO,    KC_NO , \
 ...
 * |   ~  |   !  |   @  |   #  |   $  |   %  |             |      |      | PGDN | PGUP |   )  | PIPE |
 * |------+------+------+------+------+------|             |------+------+------+------+------+------|
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  |             | LEFT | DOWN |  UP  | IGHT |   \  |  |   |
 * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |      |      |      |      |      |      |      |      |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |      |      |      |      |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   _______,    KC_PGDN,    KC_PGUP,    KC_INSERT, _______, KC_PIPE,  \
  _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, _______, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  RESET, _______, _______, _______, KC_END,  KC_HOME, _______, _______,\
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, RESET,  KC_F12,  KC_NUHS, KC_NUBS, _______, _______, _______, \
                    _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______\
),
